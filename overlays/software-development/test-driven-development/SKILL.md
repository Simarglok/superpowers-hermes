...
For fixture design, mock misuse, test-only production hooks, and incomplete integration tests, load [`references/testing-anti-patterns.md`](references/testing-anti-patterns.md).
